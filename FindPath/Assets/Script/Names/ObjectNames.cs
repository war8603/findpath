...
namespace FindPath
{
    public class ObjectNames
    {
        ...
        public const string CharacterPrefabName = "Character";
        public const string FogPrefabName = "Fog";
        public const string LightPrefabName = "Light";
        public const string CoinPrefabName = "Coin";
